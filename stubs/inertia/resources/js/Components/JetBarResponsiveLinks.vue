<template>
  <div class="relative block lg:hidden" v-if="page.props.jetstream.hasTeamFeatures">
    <button
      @click="showingSidebarManageTeamsDropdown = !showingSidebarManageTeamsDropdown"
  ...
  <div
    v-show="showingSidebarManageAccountDropdown"
    @click="showingSidebarManageAccountDropdown = false"
  ...
  <div class="relative block lg:hidden">
    <button
      @click="showingSidebarManageAccountDropdown = !showingSidebarManageAccountDropdown"
      class="flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 lg:block hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
    >
  ...
  <div
    v-show="showingSidebarManageTeamsDropdown"
    @click="showingSidebarManageTeamsDropdown = false"
    class="fixed inset-0 h-full w-full z-10"
    style="display: none"
  ></div>
</template>
...
let showingSidebarManageAccountDropdown = ref(false)
let showingSidebarManageTeamsDropdown = ref(false)
